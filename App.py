...
'''backgroundInicio = customtkinter.CTkImage(Image.open('img/BackgroundImage.png'), size=(1000,500))
backgroundInicio = customtkinter.CTkLabel(master=self.tab('Inicio'), image=self.backgroundInicio, text='').place(relx=0.0001, rely=0.001)
'''
...
def bar():
	label = Label(windows, text = 'Carregando...', fg = '#27C4B7', bg = '#161c2e', font = 'Poppins 10 bold').place(x = 18, y = 210)
	import time
	r = 0
	for i in range(100):
		progresso['value']=r
...
Frame(windows, width = 427, height = 241, bg = "#161c2e").place(x=0,y=0)
...
label1 = Label(windows, text = "I.A. SECURITY VISION", fg = '#27C4B7', bg = "#161c2e", font = 'Poppins 18 bold').place(x = 150, y = 80)
logo = PhotoImage(file = "img/IASecurityVisionPNGVersion-150.png")
img = Label(windows, bg = '#161c2e', image = logo).place(x = 0, y = 25)
windows.mainloop()
